...
- (void)initialiseControl {
    ...
    self.leftHandle.contents = (id)[UIImage imageNamed:@"music_slider_circle.png"].CGImage;
    
    self.leftHandle.cornerRadius = 8.0f;
    self.leftHandle.backgroundColor = [UIColor lightGrayColor].CGColor;//self.tintColor.CGColor;
