...
@interface TYLabelViewController ()<UITableViewDelegate,UITableViewDataSource,TYAttributedLabelDelegate>
...
- (void)viewDidLoad {
    ...
    [self.tableView registerClass:[TYLabelCell class] forCellReuseIdentifier:@"TYLabelCell"];
...
{
    NSString *text = @"@青春励志: [haha,15,15]其实所有漂泊的人，[haha,15,15]不过是为了有一天能够不再漂泊，[haha,15,15][haha,15,15]能用自己的力量撑起身后的家人和自己爱的人。 [haha,15,15]#青春励志#[button]@青春励志: [haha,15,15]其实所有漂泊的人，[haha,15,15]不过是为了有一天能够不再漂泊，[haha,15,15][haha,15,15]能用自己的力量撑起身后的家人和自己爱的人。 [haha,15,15]#青春励志#[button]@青春励志: [haha,15,15]其实所有漂泊的人，[haha,15,15]不过是为了有一天能够不再漂泊，[haha,15,15][haha,15,15]能用自己的力量撑起身后的家人和自己爱的人。 [haha,15,15]#青春励志#[button]";
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    TYLabelCell *cell = [tableView dequeueReusableCellWithIdentifier:@"TYLabelCell" forIndexPath:indexPath];
